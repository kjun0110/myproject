...
@seoul_router.get("/preprocess/{data_type}")
async def get_preprocess_data(data_type: str):
    ...
    Example:
        GET /seoul_crime/preprocess/cctv
        GET /seoul_crime/preprocess/crime
        GET /seoul_crime/preprocess/pop
    """
    try:
