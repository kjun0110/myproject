            ...
            <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
                <main className="flex w-full max-w-md flex-col items-center gap-8 py-16 px-6">
                    <div className="flex w-full flex-col items-center gap-6 text-center">
                        ...
                        <button
                            onClick={() => router.push("/")}
                            className="flex h-12 w-full max-w-xs items-center justify-center gap-3 rounded-lg bg-[#4285F4] px-6 text-base font-medium text-white transition-colors hover:bg-[#357AE8]"
                        >
                            홈으로 돌아가기
                        </button>
                    </div>
