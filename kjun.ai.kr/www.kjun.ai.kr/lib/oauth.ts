...
import { API_GATEWAY_URL, STORAGE_KEYS, ERROR_MESSAGES } from "@/constants/oauth";
 ...
 */
export function getLoginProvider(): OAuthProvider | null {
    return localStorage.getItem(STORAGE_KEYS.LOGIN_PROVIDER) as OAuthProvider | null;
}
